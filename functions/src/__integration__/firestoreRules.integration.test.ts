...
describe("rules: courses", () => {
  test("create Admin/Trainer con contatori azzerati → OK; subscribed>0 / User / id/uid-mismatch / trainerId altrui → NEGATA", async () => {
    ...
    // uid non coerente col documentId: le Functions cercano i corsi per campo uid.
