...
import 'package:fitrope_app/authentication/resend_verification_email.dart';
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: TextField(
            key: const Key('login-reset-email-field'),
                  ...
                  children: [
                    Column(
                      ...
                      children: [
                        ...
                        if (emailNotVerified)
                          ElevatedButton(
                            key: const Key('login-resend-verification-button'),
                            style: ButtonStyle(
