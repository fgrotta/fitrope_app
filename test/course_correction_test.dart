...
void main() {
  group('Course Correction Feature Tests', () {
    ...
    test('should detect mismatch and show correction button for Admin', () {
      ...
      expect(isAdmin, true);
      expect(
          hasMismatch && isAdmin, true); // Il pulsante dovrebbe essere visibile
    });
    ...
    test('should detect mismatch and show correction button for Trainer', () {
      ...
      expect(hasMismatch && userRole == 'Trainer',
          true); // Il pulsante dovrebbe essere visibile
    });
    ...
    test('should not show correction button for regular User', () {
      ...
      bool showButton =
          hasMismatch && (userRole == 'Admin' || userRole == 'Trainer');
      expect(showButton,
          false); // Il pulsante NON dovrebbe essere visibile per utenti normali
    });
    ...
    test('should not show correction button when there is no mismatch', () {
      ...
      expect(isAdmin, true);
      expect(hasMismatch && isAdmin,
          false); // Il pulsante NON dovrebbe essere visibile
    });
