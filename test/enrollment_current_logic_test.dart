  ...
  group('Current Enrollment Logic Tests', () {
    ...
    setUp(() {
      ...
      testCourse1 = Course(
        ...
        name: 'Corso Lunedì',
        startDate:
            Timestamp.fromDate(mondayThisWeek.add(const Duration(hours: 10))),
        endDate:
            Timestamp.fromDate(mondayThisWeek.add(const Duration(hours: 11))),
        capacity: 20,
        subscribed: 5,
      );
      ...
      testCourse2 = Course(
        ...
        startDate: Timestamp.fromDate(
            mondayThisWeek.add(const Duration(days: 1, hours: 10))),
        endDate: Timestamp.fromDate(
            mondayThisWeek.add(const Duration(days: 1, hours: 11))),
        capacity: 20,
        subscribed: 5,
      );
      ...
      testCourse3 = Course(
        ...
        startDate: Timestamp.fromDate(
            mondayThisWeek.add(const Duration(days: 2, hours: 10))),
        endDate: Timestamp.fromDate(
            mondayThisWeek.add(const Duration(days: 2, hours: 11))),
        capacity: 20,
        subscribed: 5,
      );
      ...
      userAbbonamentoMensile = FitropeUser(
        ...
        courses: [
          'course-1',
          'course-2'
        ], // Iscritto a 2 corsi questa settimana
    ...
    group('CourseUnsubscribeHelper.canUnsubscribe for Temporal Subscriptions',
        () {
      test(
          'should not require confirmation for temporal subscriptions (current logic)',
          () {
        ...
        final result =
            CourseUnsubscribeHelper.canUnsubscribe(courseFar, userWithCourse);
      ...
      test(
          'should not require confirmation even for course starting soon (current logic)',
          () {
        ...
        final result =
            CourseUnsubscribeHelper.canUnsubscribe(courseSoon, userWithCourse);
